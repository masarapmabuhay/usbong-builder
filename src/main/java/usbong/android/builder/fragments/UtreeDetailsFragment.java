 ...
 * interface.
 */
public class UtreeDetailsFragment extends Fragment implements Observer<List<Utree>> {

    private ProgressDialog dialog;
    public static final String TAG = UtreeDetailsFragment.class.getSimpleName();
    ...
    public static UtreeDetailsFragment newInstance() {
...
//                    selectedUtree = null;
                    controller.fetchUtrees(UtreeDetailsFragment.this);
